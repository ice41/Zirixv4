...
config.group = "taxi" -- SET QUE SERA DADO AO INICIAR A ROTA
config.remgroup = "taxi" -- SET QUE SERA TIRADO AO ENCERRAR A ROTA
config.permgroup = "taxi" -- PERMISSAO PARA RECEBER CHAMADO DE PLAYERS

-- VALOR MATH.RANDOM QUE IRA RECEBER AO ENTREGAR O NPC, LEMBRANDO QUE ELE NAO PAGA SE PASSAR DE X VELOCIDADE
config.taxipayment = { 1500 , 2000 }

config.maxvel = 120 -- VELOCIDADE MÁXIMA DO TAXISTA PARA NAO TOMAR PUNIÇÃO
