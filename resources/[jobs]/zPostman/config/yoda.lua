...
config.boxpostman = "caixa-vazia" -- ITEM E QUANTIDADE PARA FAZER UMA ENCOMENDA
config.ammountpostman = 3
config.orderpostman = "encomenda" -- ITEM E QUANTIDADE QUE IRA VIM AO FAZER A ENCOMENDA
config.ammoutorder = 3
config.animpostman = "amb@prop_human_parking_meter@female@idle_a" -- ANIMAÇAO PARA MAIS INFORMAÇÕES https://wiki.rage.mp/index.php?title=Animations
config.animname = "idle_a_female" -- NOME DA ANIMAÇÃO

config.postmandelivery = { 2 , 6 } -- DELIVERY MATH.RANDOM, VAI ENTREGAR ENTRE 2 E 6
config.postmanitem = "encomenda" -- ITEM QUE SERA ENTREGUE NAS ROTAS
config.postmanpayment = { 200 , 500 } -- PAGAMENTO MATH.RANOM, ENTRE 200 A 500 POR ENTREGA
config.postmanveh = "boxville2" -- VEICULO NECESSARIO PARA INICIAR A ROTA

-- LOCAL PARA FAZER A ENCOMENDA
config.startpostman = {
    ['x'] = 78.91, ['y'] = 112.36, ['z'] = 81.17
}

-- LOCALIZAÇÃO PARA INICIAR (Delivery)
config.postmanloc = {
    ['x'] = 53.6, ['y'] = 114.86, ['z'] = 79.2
}

-- LOCALIZAÇÃO PARA ENTREGA DAS ENCOMENDAS (Delivery)
