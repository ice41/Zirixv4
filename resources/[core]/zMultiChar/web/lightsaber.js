...
const updateChars = () => {
    $.post("https://zMultiChar/getCharacters",JSON.stringify({}),(data) => {
...
$(document).on('click','.char',function(){
    ...
    if($em) {
        $.post('https://zMultiChar/spawnChar',JSON.stringify({
...
$(document).on('click', '.slot',function(){
	$.post('https://zMultiChar/newChar',JSON.stringify({
...
$(document).on('click','#spawn-buttom',function(){
	...
	if($el) {
		if (id) {
			$.post('https://zMultiChar/joinInTheCity',JSON.stringify({
				id: id
			}))
		}	
	}
