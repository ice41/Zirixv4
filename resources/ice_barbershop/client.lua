...
local es = {
	...
	["Pecas"] = 9,
	["Pelo en el pecho"] = 10,
	["Manchas en el cuerpo"] = 11,
	["Pelo"] = 12,
	["Color de cabello secundario"] = 13
}
...
local fr = {
	...
	["Rides"] = 6,
	["Rouge à lèvres"] = 8,
	["Taches de rousseur"] = 9,
	["poils de poitrine"] = 10,
	["Imperfections sur le corps"] = 11,
	["Cheveux"] = 12,
	["Sec Couleur des cheveux"] = 13
}
...
local ua = {
	...
	["Помада"] = 8,
	["Веснянки"] = 9,
	["Волосся на грудях"] = 10,
	["Плями на тілі"] = 11,
	["Волосся"] = 12,
	["Вторинний колір волосся"] = 13
}

--[[ i make this options but you can make more
	pt-portuguese, es- espanish, fr- fransh, en- english, dk - danish, ua - ucranian

	to make more options just make you new local like examples
		...
		for k, v in pairs(barberShops) do
            ...
            if noProvador then
                if GetDistanceBetweenCoords(GetEntityCoords(ped), provador.x, provador.y, provador.z, true ) < 0.5 and not chegou then
                    ...
                    SetEntityInvincible(ped, true) --if use MQCU set false
                    openGuiBarberShop()
                end
            end
        end
