...
zSERVER = Tunnel.getInterface('zPlayer')
...
function z.cleanResidual()
	residual = false
end

function z.putVehicle(vehIndex)
...
function z.toggleLivery(number)
	local ped = PlayerPedId()
	if IsPedInAnyVehicle(ped) then
...
-- Peds em locais específicos (npcs)
