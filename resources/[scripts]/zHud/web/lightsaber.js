$(document).ready(function(){
  window.addEventListener('message', function(event){
    ...
    $("#time").html("<img src='images/time.svg'><p>" + data.hours + ':' + data.minutes + '</p>');
    $("#address").html("<img src='images/address.svg'><p>" + data.address + '.</p>');
    if (data.talking == true) {
      $('#voice').css('color', '#ffb031');
      $("#voice").html("<img src='images/voiceOn.svg'><p>" + data.voice + '</p>');
    }   
    else {
      $('#voice').css('color', 'white');
      $('#radio').css('color', 'white');  
      $("#voice").html("<img src='images/voiceOff.svg'><p>" + data.voice + '</p>');
      $("#radio").html("<img src='images/radioOff.svg'><p>" + data.radio + '</p>');
    }
